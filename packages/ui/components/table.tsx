...
>(({ className, ...props }, ref) => (
  <tfoot
    ref={ref}
    className={cn("border-t border-slate-100 bg-slate-50 font-bold [&>tr]:last:border-b-0 text-xs", className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-9 px-4 text-left align-middle text-[10px] font-extrabold uppercase tracking-wider text-slate-400 [&:has([role=checkbox])]:pr-0 whitespace-nowrap",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn("px-4 py-3 align-middle text-xs font-semibold text-slate-800 [&:has([role=checkbox])]:pr-0", className)}
    {...props}
  />
));
